...
export const STRINGS = {
  fr: {
    ...
    about: {
      ...
      howTitle: "Ce que change un bon filigrane",
      how: [
        { title: "Un usage unique", body: "« Pour ma location », « pour ma banque » : toute autre utilisation devient visiblement abusive." },
        { title: "Une trace", body: "Un destinataire et une date rendent la copie nominative. Si elle fuit, on sait d'où elle vient." },
        { title: "Un obstacle", body: "Le texte en travers du document dissuade la réutilisation et complique toute falsification." },
      ],
      ...
      ctaBody: "Un texte clair en travers de vos documents sensibles. Rien ne quitte votre appareil.",
      ctaButton: "Filigraner un document",
    },
    errors: {
  ...
  en: {
    ...
    about: {
      ...
      howTitle: "What a good watermark changes",
      how: [
        { title: "A single purpose", body: "“For my rental”, “for my bank”: any other use becomes visibly improper." },
        { title: "A trace", body: "A recipient and a date make the copy nominative. If it leaks, you know where it came from." },
        { title: "A barrier", body: "Text across the document deters reuse and makes any forgery harder." },
      ],
      ...
      ctaButton: "Watermark a document",
    },
    errors: {
  ...
  ja: {
    ...
    about: {
      ...
      howTitle: "透かしがもたらす違い",
      how: [
        { title: "用途を一つに", body: "「賃貸用」「銀行用」と示せば、それ以外の利用は一目で不正だと分かります。" },
        { title: "たどれる印", body: "宛先と日付を入れると、コピーは名前入りになります。漏れても出どころが分かります。" },
        { title: "再利用の壁", body: "書類を斜めに横切る文字が再利用を思いとどまらせ、改ざんも難しくします。" },
      ],
      ...
      ctaTitle: "わずか十秒",
      ctaBody: "大切な書類に、はっきりとした一文を斜めに重ねるだけ。何も端末の外には出ません。",
      ctaButton: "書類に透かしを入れる",
    },
    errors: {
